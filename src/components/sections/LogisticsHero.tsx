    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl">
        ...
        <p className="lg-hero-fade mt-8 max-w-2xl font-sans text-base leading-relaxed text-zinc-400 md:text-lg">
          We operate the physical side of your business — fulfilment, freight and returns —
          across Dubai, the UAE and the wider GCC, as a single connected system synced live with
          your storefront and ERP.
        </p>
      </div>
    </section>
  );
